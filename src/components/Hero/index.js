    ...
    <section className="text-gray-600 body-font mt-20">
      <div className="container mx-auto flex px-5 py-24 md:flex-row md:justify-center flex-col items-center">
        <div className="md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">At our company, we are dedicated to providing an unparalleled online shopping experience, bringing you a vast array of high-quality products right at your fingertips. As a leading eCommerce platform, we take pride in offering a diverse and curated selection of items that cater to your every need.</p>
